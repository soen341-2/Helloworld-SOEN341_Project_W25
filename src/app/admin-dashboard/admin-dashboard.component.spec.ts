...
describe('AdminDashboardComponent', () => {
  ...
  it('should alert if user tries to assign user to channel', async () => {
    ...
    expect(window.alert).toHaveBeenCalledWith('Only Admins or SuperAdmins can assign users to channels!');
  });
  ...
  it('should alert if user tries to toggle channel assignment of other users', async () => {
    ...
    expect(window.alert).toHaveBeenCalledWith('Only Admins or SuperAdmins can manage channels!');
  });
  ...
  it('should alert if non-superadmin tries to promote a user', async () => {
    ...
    expect(window.alert).toHaveBeenCalledWith('Only SuperAdmins can assign admins!');
  });
  ...
  it('should alert if non-superadmin tries to demote a user', async () => {
    ...
    expect(window.alert).toHaveBeenCalledWith('Only SuperAdmins can remove admins!');
  });
});
